						...
						<div class="py-5 px-5">
							...
							<form action="/product/insert.do" method="post" enctype="multipart/form-data">
									...
									<div class="row mb-4 justify-content-center">
										...
										<div class="col-sm-7">
											<input type="text" class="form-control" name="price" id="price" placeholder="숫자만 입력해주세요">
										</div>
									</div>
									<div class="row mb-4 justify-content-center">
										<label for="servingSize" class="col-sm-2 col-form-label">수량</label>
										<div class="col-sm-7">
											<input type="text" class="form-control" name="servingSize" id="servingSize" placeholder="숫자만 입력해주세요">
										</div>
									</div>
									<div class="row mb-4 justify-content-center">
								...
								<div class="my-4 d-grid gap-5 d-md-flex justify-content-md-center">
									<button type="submit" class="btn btn-lg rounded-pill shadow-sm" style="width: 230px; height: 60px; background-color: #04D9C4; color: #ffffff; font-size: 18px;">등록하기</button>
									<button type="reset" class="btn btn-light btn-lg rounded-pill shadow-sm" style="width: 230px; height: 60px; background-color: #BEBEBE; color: #ffffff; font-size: 18px;">초기화</button>
								</div>
							</form>
						</div>
					</div>
