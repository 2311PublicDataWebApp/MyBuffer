				...
				<ul>
					...
					<div class="row my-4 justify-content-center ">
						<li>
							...
							<div id="content" class="word-wrap  word-break">
							<textarea style="width: 799px; height: 800px; background-color: #f1f3f5; border: 1px solid black;"  class="overflow-auto text-wrap">${notice.noticeContent }</textarea>
							</div>
						</li>
					</div>
