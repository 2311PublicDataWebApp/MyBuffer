		...
		<form action="/notice/insert.do" method="post" enctype="multipart/form-data">
			...
			<div class="row mb-4 justify-content-center">
				...
				<li>
					...
					<textarea class="form-control" id="exampleFormControlTextarea1" rows="15" cols="100" name="noticeContent"></textarea>
				</li>
			<div class="row mb-4 justify-content-center">
				<li>
					<label>첨부파일</label>
			...
			<div class="row">
				<div class="container text-center">
					<input type="submit" value="등록" class="btn btn-lg rounded-pill"
