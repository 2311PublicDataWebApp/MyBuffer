...
<body>
	...
	<div class="container">
		<main class="my-5">
			<h1 class="mb-4 py-3">공지사항 작성</h1>
			<br>
			<form action="/notice/insert.do" method="post"
				enctype="multipart/form-data">
				<ul>
					<div class="row mb-4 justify-content-center">
						<li><label for="brandName" class="col-sm-2 col-form-label">제목</label>
							<input type="text" name="noticeName"></li>
					</div>

					<div class="row mb-4 justify-content-center">
						<li><label for="brandName" class="col-sm-2 col-form-label">작성자</label>
							<input type="text" name="noticeWriter"></li>
					</div>
					<li><label for="exampleFormControlTextarea1" class="form-label">내용</label> 
						<textarea class="form-control" id="exampleFormControlTextarea1" rows="15" cols="100" name="noticeContent"></textarea></li>
					<div class="row mb-4 justify-content-center">
						<li><label>첨부파일</label> 
				...
				<div class="row">
					<div class="container text-center">
						<input type="submit" value="등록" class="btn btn-lg rounded-pill" style="width: 220px; height: 60px; background-color: #04D9C4; color: #ffffff;">
					</div>
				</div>
				<br>
				<br>
