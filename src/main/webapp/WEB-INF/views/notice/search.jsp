...
<%-- 							</c:if> --%>
			...
			<c:if test="${memberId eq 'admin' }">
				<div class="container text-center">
					<button type="button" class="btn btn-lg rounded-pill"
						...
						onclick="showInsertPage();">등록하기</button>
	...
	<footer
		class="d-flex flex-wrap justify-content-between align-items-center py-5 border-top"
		style="background-color: #F9FFFD; - -bs-gutter-x: 0;">
		<div class="col-md-1 d-flex justify-content-center align-items-center"></div>
		<div
			class="col-md-4 pt-3 pb-2 d-flex justify-content-center align-items-center border-end border-1">
