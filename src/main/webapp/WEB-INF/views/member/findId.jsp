    ...
    <main class="my-5">
        <div class="container mt-5 d-flex justify-content-center align-items-center">
            <div class="card shadow p-3 mb-5 bg-white rounded" style="width: 25rem;">
                ...
                <form action="/member/findid.do" method="post" class="p-3">
                    <div class="mb-3">
                        <label for="memberEmail" style="font-weight: bold;">이메일</label>
                    ...
                    <br><br>
                    <div class="text-center">
                        <a href="/member/findid.do" style="font-weight: bold;  color: black;" >아이디 찾기</a>
                        <a href="/member/findpassword.do" style="font-weight: bold;  color: black;">비밀번호 찾기</a>
                        <a href="/member/register.do" style="font-weight: bold;  color: black;">회원가입</a>
                    </div>
                </form>
            </div>
        </div>
